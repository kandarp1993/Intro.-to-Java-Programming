 ...
 * CWID - 10419687
 * Date - 09/26/2017
 * Description - Test program to solve the linear equation class.    
 **/

import javax.swing.JOptionPane;

public class C9E11E12TestLinearEquation {
		...
		while (continueProgram) {
			try {
				int option = Integer.parseInt(JOptionPane.showInputDialog(null,
						"1. Solve the linear Equation.\n"+ linearEquation+"\n\n2. Find the Point of Intersection for the lines with points (x1, y1) (x2, y2) and (x3, y3) (x4, y4). \n\n Select the program (1 or 2) you want to execute?", "Input",
				...
				case 1:
					String input1 = JOptionPane
							.showInputDialog(
									null,
									"Linear equations\n"+ linearEquation+"\n Enter a, b, c, d, e, f numbers separated with comma",
					...
					C9E11LinearEquation linear = new C9E11LinearEquation(a, b,c, d, e, f);
				...
				case 2:
					...
					.showInputDialog(
							null,
							"Enter (x1, y1) (x2, y2) of first line and (x3, y3) (x4, y4) of second line separated with comma",
							"Input", JOptionPane.QUESTION_MESSAGE);
					...
					C9E11LinearEquation linearEq = new C9E11LinearEquation(x1, y1, x2, y2, x3, y3, x4, y4);
