 ...
 * CWID - 10419687
 * Date - 09/26/2017
 * Description - A class for a system of linear equations.    
 **/

public class C9E11LinearEquation {
	private double a, b, c, d, e, f;
	private double x1, y1, x2, y2, x3, y3, x4, y4;
	C9E11LinearEquation(double A, double B, double C, double D, double E, double F) throws Exception{
			setA(A); 
			setB(B); 
			setC(C); 
			setD(D); 
	...
	C9E11LinearEquation(double X1, double Y1, double X2, double Y2, double X3, double Y3, double X4, double Y4) {
